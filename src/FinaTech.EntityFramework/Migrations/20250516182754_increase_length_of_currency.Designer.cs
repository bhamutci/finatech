...
namespace FinaTech.EntityFramework.Migrations
{
    ...
    [Migration("20250516182754_increase_length_of_currency")]
    partial class increase_length_of_currency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinaTech.Core.Account.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FinaTech.Core.Payment", b =>
                {
                    b.HasOne("FinaTech.Core.Account.Account", "BeneficiaryAccount")
                        .WithMany()
                        .HasForeignKey("BeneficiaryAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinaTech.Core.Account.Account", "OriginatorAccount")
                        .WithMany()
